  ...
  return (
    <>
      <div className={appSt.container}>
        ...
        <div className={appSt.grid}>
          <a
            ...
            onClick={() => window.gtag('event', 'Alfapotok_3531_7')}
          >
            <div>
          ...
          <a
            ...
            onClick={() => window.gtag('event', 'DFA_7')}
          >
            <div>
              <Typography.Text view="primary-medium" tag="p" defaultMargins={false} weight="medium">
                ЦФА
          ...
          <a
            ...
            onClick={() => window.gtag('event', 'Fonds_7')}
          >
            <div>
              <Typography.Text view="primary-medium" tag="p" defaultMargins={false} weight="medium">
                Фонды
          ...
          <a
            ...
            onClick={() => window.gtag('event', 'DU_7')}
          >
            <div>
              <Typography.Text view="primary-medium" tag="p" defaultMargins={false} weight="medium">
                ДУ
          ...
          <a
            ...
            onClick={() => window.gtag('event', 'IIS_7')}
          >
            <div>
              <Typography.Text view="primary-medium" tag="p" defaultMargins={false} weight="medium">
                ИИС
      ...
      <div className={appSt.bottomBtn}>
        <ButtonMobile block view="primary" href="alfabank://investments" onClick={() => window.gtag('event', 'Vitrina_7')}>
          Витрина инвестиций
        </ButtonMobile>
      </div>
      <BottomSheet
        ...
        onClose={() => {
          if (selectedItem === 'isz') {
            window.gtag('event', 'ISG_Exit_7');
          } else {
            window.gtag('event', 'NSG_Exit_7');
          }
          setOpenBs(false);
        }}
        hasCloser
        ...
        actionButton={
          <ButtonMobile
            ...
            onClick={() => {
              if (selectedItem === 'isz') {
                window.gtag('event', 'ISG_More_info_7');
              } else {
                window.gtag('event', 'NSG_More_info_7');
              }
            }}
          >
            Подробнее на сайте
      ...
      >
        <div className={appSt.containerBS}>
          ...
          <Typography.Title
            ...
            onClick={() => {
              if (selectedItem === 'isz') {
                window.gtag('event', 'ISG_Mobile_7');
              } else {
                window.gtag('event', 'NSG_Mobile_7');
              }
