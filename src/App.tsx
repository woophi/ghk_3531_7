    ...
    <>
      <div className={appSt.container}>
        ...
        <div className={appSt.grid}>
          ...
          <a
            ...
            onClick={() => window.gtag('event', 'DFA_3531_7')}
          >
            <div>
              <Typography.Text view="primary-medium" tag="p" defaultMargins={false} weight="medium">
                ЦФА
          ...
          <a
            ...
            onClick={() => window.gtag('event', 'Fonds_3531_7')}
          >
            <div>
              <Typography.Text view="primary-medium" tag="p" defaultMargins={false} weight="medium">
                Фонды
          ...
          <a
            ...
            onClick={() => window.gtag('event', 'DU_3531_7')}
          >
            <div>
              <Typography.Text view="primary-medium" tag="p" defaultMargins={false} weight="medium">
                ДУ
      ...
      <div className={appSt.bottomBtn}>
        <ButtonMobile
          ...
          onClick={() => window.gtag('event', 'Vitrina_3531_7')}
        >
          Витрина инвестиций
        </ButtonMobile>
      </div>
      <BottomSheet
        ...
        onClose={() => {
          if (selectedItem === 'isz') {
            window.gtag('event', 'ISG_3531_Exit_7');
          } else {
            window.gtag('event', 'NSG_3531_Exit_7');
          }
          setOpenBs(false);
        }}
        hasCloser
        ...
        actionButton={
          <ButtonMobile
            ...
            onClick={() => {
              if (selectedItem === 'isz') {
                window.gtag('event', 'ISG_3531_More_info_7');
              } else {
                window.gtag('event', 'NSG_3531_More_info_7');
              }
            }}
          >
            Подробнее на сайте
      ...
      >
        <div className={appSt.containerBS}>
          ...
          <Typography.Title
            ...
            onClick={() => {
              if (selectedItem === 'isz') {
                window.gtag('event', 'ISG_3531_Mobile_7');
              } else {
                window.gtag('event', 'NSG_3531_Mobile_7');
              }
